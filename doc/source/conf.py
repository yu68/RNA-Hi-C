# -*- coding: utf-8 -*-
#
# Stitch-seq-tools documentation build configuration file, created by
...
project = u'RNA-Stitch-seq-tools'
...
latex_documents = [
  ('index', 'Stitch-seq-tools.tex', u'Stitch-seq-tools Documentation',
   u'Pengfei Yu', 'manual'),
]
